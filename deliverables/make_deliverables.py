...
# Create processed JUR databases for plots
...
# Create boxplots values table
jur.create_boxplot_values(
    processed_db_all_median, file_name="アウトプット5_1_箱ひげ図の値_全参加大学_中央値"
)
jur.create_boxplot_values(processed_db_all_mean, file_name="アウトプット5_2_箱ひげ図の値_全参加大学_平均値")
jur.create_boxplot_values(
